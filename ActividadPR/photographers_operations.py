...
async def add_photographer(db_session:AsyncSession, name:str, state:bool=None,):
...
#mostrar por id
async def show_one_photographer(photographer_id:int, db_session:AsyncSession):
...
async def show_all_photographers(db_session:AsyncSession): #db_session trae la base de datos
...
async def modify_state(photographer_id:int, actual_state:bool, db_session:AsyncSession):
...
#eliminar registro
async def remove_photographer(photographer_id:int, db_session:AsyncSession):
